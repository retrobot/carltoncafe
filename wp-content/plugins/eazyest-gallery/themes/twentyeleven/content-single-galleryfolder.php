...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		<?php
			...
			$tag_list = get_the_tag_list( '', __( ', ', 'eazyest-gallery' ) );
			if ( '' != $tag_list ) {
				$utility_text = __( 'This folder was posted in %1$s and tagged %2$s by <a href="%6$s">%5$s</a>. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'eazyest-gallery' );
			} else {
				$utility_text = __( 'This folder was posted by <a href="%6$s">%5$s</a>. Bookmark the <a href="%3$s" title="Permalink to %4$s" rel="bookmark">permalink</a>.', 'eazyest-gallery' );
			}
			...
			<div id="author-description">
				...
				<div id="author-link">
					<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author">
						<?php printf( __( 'View all entriess by %s <span class="meta-nav">&rarr;</span>', 'eazyest-gallery' ), get_the_author() ); ?>
					</a>
				</div><!-- #author-link	-->
